...
namespace MyTwitterAPI.Migrations
{
    ...
    [Migration("20231211080249_followerTableRename")]
    partial class followerTableRename
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("MyTwitterAPI.Entities.CommentNotification", b =>
                {
                    b.Property<int>("CommentNotificationId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");

                    SqlServerPropertyBuilderExtensions.UseIdentityColumn(b.Property<int>("CommentNotificationId"), 1L, 1);
            ...
            modelBuilder.Entity("MyTwitterAPI.Entities.Follower", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("MyTwitterAPI.Entities.CommentNotification", b =>
                {
                    ...
                    b.HasOne("MyTwitterAPI.Entities.User", "Receiver")
                        .WithMany()
            ...
            modelBuilder.Entity("MyTwitterAPI.Entities.Follower", b =>
                {
                    b.HasOne("MyTwitterAPI.Entities.User", "FollowerUser")
                        .WithMany()
